(function (root) {
  const MODAL_ID = "selfJsonImportModal";
  const TEXTAREA_ID = "selfJsonImportTextarea";
  const ERROR_ID = "selfJsonImportError";
  const PREVIEW_ID = "selfJsonImportPreview";
  ...
  if (typeof window !== "undefined") {
    window.ReportSelfJsonImport = {
      openImportModal,
      closeImportModal,
      importFromTextarea,
    };
    root.ReportSelfJsonImport = window.ReportSelfJsonImport;
  } else {
    root.ReportSelfJsonImport = {
      openImportModal,
      closeImportModal,
      importFromTextarea,
    };
